(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@angular/common'), require('rxjs'), require('@angular/router'), require('chart.js'), require('tslib')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/forms', '@angular/common', 'rxjs', '@angular/router', 'chart.js', 'tslib'], factory) :
	(factory((global['angular-bootstrap-md'] = {}),global.ng.core,global.ng.forms,global.ng.common,global.Rx,global.ng.router,global.Chart,global.tslib));
}(this, (function (exports,core,forms,common,rxjs,router,Chart,tslib) { 'use strict';
